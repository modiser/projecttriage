...
if(isset($_POST['but_submit'])){
    ...
    if ($uname != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from clerk_login where UsernameClerk='".$uname."' and Password='".$password."'";
...
<body>
    <div class="login1">
        ...
        <div id="div_login">
			...
			<p style="color:white;">Login as? <a href="indexr2.php">Admin</a>.</p>
        </div>
    </form>
    </div>    
    </div>
